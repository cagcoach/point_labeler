...
#ifndef INCLUDE_RV_CADCamera2_H_
#define INCLUDE_RV_CADCamera2_H_
 ...
 *  \author christian
 */
class CADCamera2 : public glow::GlCamera {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  /** \brief update the view matrix and return it. **/
  CADCamera2(std::shared_ptr<Eigen::Vector4f> refpt_,std::shared_ptr<Eigen::Matrix4f> projection_, QWidget* refwidget);
 ...
 protected:
  ...
  std::mutex mutex_;
  std::shared_ptr<Eigen::Vector4f> refpt;
  std::shared_ptr<Eigen::Matrix4f> projection;
...
#endif /* INCLUDE_RV_CADCamera2_H_ */
